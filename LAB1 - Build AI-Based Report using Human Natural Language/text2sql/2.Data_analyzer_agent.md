...
13. Klik Hamburgen Icon yang ada pada sisi kiri atas -> klik Deployment space -> klik View all deployment spaces -> klik tombol Create a deployment space

<img width="1920" height="716" alt="image" src="https://github.com/user-attachments/assets/2029f1a9-955a-44d8-abf5-820e69a6913b" />

14. Isi Name dengan "IBM Agentic Workshop Deployment Space - <Your initial>" -> pilih Deployment Stage "Development" -> pastikan Storage dan watsonx.ai runtime terpilih -> klik tombol Create

<img width="1870" height="986" alt="image" src="https://github.com/user-attachments/assets/4145375e-05a5-407f-aa80-59ad779bb2ee" />
...
1. Masuk ke halaman awal watsonx.ai -> scroll ke bawah sampai Anda menemukan "Create API Key" -> Buat dengan nama "API Key for Workshop" -> klik Create

<img width="1878" height="734" alt="image" src="https://github.com/user-attachments/assets/90b93521-4c1a-4096-a6ad-4f0bef9f7e42" />

2. Download hasilnya

<img width="923" height="309" alt="image" src="https://github.com/user-attachments/assets/ca5347f1-c75e-4758-9928-a616170bd1f4" />
...
4. Pilih deployment space yang sudah Anda buat pada sesi **Persyaratan** -> klik Create

<img width="1779" height="897" alt="image" src="https://github.com/user-attachments/assets/9dbbcb33-9295-41f5-b229-5001e2fa24ac" />
...
### Notes: 
* Anda harus membuat secret melalui tab Configure. Secret yang harus Anda buat adalah: ```bucket_name```, ```ibm_api_key_id```, ```endpoint_url``` dan ```object_key```

<img width="1781" height="895" alt="image" src="https://github.com/user-attachments/assets/830b5bbc-6ca6-4f55-ac36-6efec5343769" />
